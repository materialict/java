...
public class usIoper extends generalFunctions implements Serializable{

	String specificationName = new String();
	String implementationName = new String();

	static String myPath = new String("C:/dvo1/OUT/DICT/USIOPER/");

	usIoper(ArrayList<ArrayList<String>> myValues){
		...
		for (int i=0; i<myValues.size(); i++){
			...
			} else if (myValues.get(i).get(0).equals("ULITOPERNAM")){
			} else if (myValues.get(i).get(0).equals("URETVAL")){
			} else if (myValues.get(i).get(0).equals("UCNTXT")){
			} else if (myValues.get(i).get(0).equals("UIMPLEMENTED")){
			} else if (myValues.get(i).get(0).equals("UBODY")){
			} else if (myValues.get(i).get(0).equals("UEXCEPT")){
			} else if (myValues.get(i).get(0).equals("UOPERATTR")){
			} else if (myValues.get(i).get(0).equals("UCOMMENT")){
			} else if (myValues.get(i).get(0).equals("USDATA")){
			} else if (myValues.get(i).get(0).equals("URETTYPE")){
			} else {
				System.out.println("USIOPER: No value found for key " + myValues.get(i).get(0));
			}
		}
