...
public class ugFsyn extends generalFunctions implements Serializable{

	String syntaxName = new String();

	static String myPath = new String("C:/dvo1/OUT/DICT/UGFSYN/");

	ugFsyn(ArrayList<ArrayList<String>> myValues){
		...
		for (int i=0; i<myValues.size(); i++){
			...
			if (myValues.get(i).get(0).equals("UTIMESTAMP")){
				...
				this.syntaxName = myValues.get(i).get(1);
				...
				System.out.println("UGFSYN: No value found for key " + myValues.get(i).get(0));
			}
		}
	...
	private String getFilename(){
		...
		String myFilename = new String(this.syntaxName);
